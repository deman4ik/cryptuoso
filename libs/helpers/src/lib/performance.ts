...
export function sortino(return_values: number[], target_return = 0) {
    ...
    // Step 3
    const underperformance_squared_average =
        underperformance_squared.reduce((a, b) => a + b, 0) / underperformance_squared.length;
