...
import AdaptiveCard from "./adaptiveCard.json";
...
export class CardsSampleDialog extends ComponentDialog {
    constructor() {
        super("MainDialog");
        ...
        this.addDialog(
            new WaterfallDialog(MAIN_WATERFALL_DIALOG, [this.choiceCardStep.bind(this), this.showCardStep.bind(this)])
        );
     ...
     * @param {WaterfallStepContext} stepContext
     */
    public async showCardStep(stepContext: WaterfallStepContext) {
